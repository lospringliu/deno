// deno run https://raw.githubusercontent.com/lospringliu/deno/master/vue/example-reactivity.ts

import * as reactivity from "./reactivity/index.ts"
...
let reffect
const rreffect	= reactivity.effect(() => reffect = factors.price * factors.quantity, {lazy: true, onTrigger: () => console.log("triggered")})
console.log(`reactive total: ${reffect}`)
rreffect()
const non_reactive = factors.price * factors.quantity
const computed_reactive = reactivity.computed(() => factors.price * factors.quantity)
